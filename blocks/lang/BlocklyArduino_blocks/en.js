...
//15 november sdc fixed labels to match Arduino ref
Blockly.Msg.ARRAY_CREATE_EMPTY_TITLE = 'empty!';
Blockly.Msg.ARRAY_CREATE_WITH = "array values";
...
Blockly.Msg.ARRAY_CREATE_WITH_INPUT_WITH = "initial";
Blockly.Msg.ARRAY_CREATE_WITH_ITEM_TITLE = "item";
Blockly.Msg.ARRAY_CREATE_WITH_ITEM_TOOLTIP = "Add an item to the array.";
Blockly.Msg.ARRAY_CREATE_WITH_TOOLTIP = "initialize array variables";
Blockly.Msg.ARRAY_GETINDEX_AT = "index";
Blockly.Msg.ARRAY_GETINDEX_AT1 = "get index";
Blockly.Msg.ARRAY_GETINDEX_AT2 = "index";
Blockly.Msg.ARRAY_GETINDEX_HELPURL = "";
Blockly.Msg.ARRAY_GETINDEX_ITEM = "element in array";
Blockly.Msg.ARRAY_GETINDEX_TOOLTIP = "returns element in array at index";
Blockly.Msg.ARRAY_GETINDEX_TOOLTIP1="returns value in array";
Blockly.Msg.ARRAY_GETINDEX_TOOLTIP2="create array of the specified variable type";
Blockly.Msg.ARRAY_GETINDEX_TOOLTIP3="change element at index";
Blockly.Msg.ARRAY_CREATE = "array ";
Blockly.Msg.ARRAY_SP= " ";
Blockly.Msg.ARRAY_OF = "type"
Blockly.Msg.ARRAY_TAILLE = "length or size";
Blockly.Msg.ARRAY_CONTIENT = "initialize";
Blockly.Msg.ARRAY_LIST = "1D";
Blockly.Msg.ARRAY_ARRAY = "2D";
...
Blockly.Msg.ARRAY_MODIFY_INDICE = "at index";
Blockly.Msg.ARRAY_MODIFY_NAME = "set element in array";
Blockly.Msg.ARRAY_MODIFY_VALUE = "to value";
Blockly.Msg.ARRAY_MODIFY_TOOLTIP = "set value in array at index";
...
Blockly.Msg.ARD_TYPE_LONG = "long (4 bytes)";
Blockly.Msg.ARD_TYPE_NULL = "Null";
Blockly.Msg.ARD_TYPE_NUMBER = "integer";
Blockly.Msg.ARD_TYPE_SHORT = "byte";
Blockly.Msg.ARD_TYPE_TEXT = "text";
Blockly.Msg.ARD_TYPE_UNDEF = "Undefined";
Blockly.Msg.ARD_TYPE_UNS_NUMBER = "unsigned integer";
Blockly.Msg.ARD_TYPE_UNS_LONG = "unsigned long (4 bytes)";
...
//sdc sdded itoa
Blockly.Msg.CONVERSION_ITOA = "itoa";
Blockly.Msg.CONVERSION_ITOA_BUF = "buf";
Blockly.Msg.CONVERSION_ITOA_NAME = "Input";
...
Blockly.Msg.GROVE_GBK = "Grove GBK";  //added 9 August 2020
Blockly.Msg.GROVE_GBK_IN = "GBK Inputs";
Blockly.Msg.GROVE_GBK_OUT = "GBK Outputs";
...
Blockly.Msg.ARDUINO_BASE_DELAY_DELAY_TIME = "delay (mS)";
Blockly.Msg.ARDUINO_BASE_DELAY_DELAY_TIME_SEC = "delay (S)";
...
Blockly.Msg.ARDUINO_BASE_INCLUDE_FILE_NAME = "file name";
Blockly.Msg.ARDUINO_BASE_INCLUDE_FILE_TOOLTIP = "Inlcude file in working directory";
...
Blockly.Msg.ARDUINO_INOUT_BUILDIN_LED_INPUT = "set the LEDs on the card to logic";
Blockly.Msg.ARDUINO_INOUT_BUILDIN_LED_TOOLTIP = "turn the LED on the Arduino board on oroff";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_HELPURL = "http://arduino.cc/en/Reference/DigitalWrite";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_INPUT1 = "set the digital pin";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_INPUT2 = "to logic state";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_TOOLTIP = "write a 0 or 1 specified digital output";
...
Blockly.Msg.ARDUINO_INOUT_DIGITAL_READ_TOOLTIP = "read the state of the digital pin";
...
Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_INPUT1 = "write analog pin";
Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_INPUT2 = "value";
Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_TOOLTIP = "write a value between 0 and 255 on a specific output";
Blockly.Msg.ARDUINO_TONE_HELPURL = "http://arduino.cc/en/Reference/AnalogWrite";
Blockly.Msg.ARDUINO_TONE_INPUT1 = "emit sound on the pin";
Blockly.Msg.ARDUINO_TONE_INPUT2 = "frequency (Hz)";
Blockly.Msg.ARDUINO_TONE_INPUT3 = "for time (ms)";
...
Blockly.Msg.ARDUINO_SERIAL_PRINTLN_CONTENT = "Serial Print with new line";
Blockly.Msg.ARDUINO_SERIAL_PRINT_TAB_CONTENT = "Serial Print with 'tab'";
Blockly.Msg.ARDUINO_SERIAL_PRINT_TOOLTIP = "sends data over the serial port to the Serial Monitor in ASCII";
...
Blockly.Msg.ARDUINO_SERIAL_PRINT_MULTI_NUMBER = "Serial Write";
Blockly.Msg.ARDUINO_SERIAL_PRINT_MULTI_NEWLINE = "with new line?";
Blockly.Msg.ARDUINO_SERIAL_PRINT_MULTI_FIELDDROPDOWN = [["yes", "true"], ["no", "false"]];
...
//SERIAL
Blockly.Msg.Serial_Init="Serial communication speed";
...
Blockly.Msg.CONVERSION_MAP_NUM = "map input value";
Blockly.Msg.CONVERSION_MAP_IN_MIN = "low value";
Blockly.Msg.CONVERSION_MAP_IN_MAX = "high value";
Blockly.Msg.CONVERSION_MAP_OUT_MIN = "mapped low";
Blockly.Msg.CONVERSION_MAP_OUT_MAX = "mapped high";
Blockly.Msg.CONVERSION_MAP_TOOLTIP = "maps a number from one range to another";
...
//added 5/3/19
Blockly.Msg.mhp_for = "for";
Blockly.Msg.mhp_for_eq = "=";
Blockly.Msg.mhp_for_spa = " ";
Blockly.Msg.mhp_for_sem = "test";
Blockly.Msg.mhp_for_inc = "step";
...
//added 9 August 2020
//outputs
Blockly.Msg.grove_gbk_led1 = "write to LED on D4";
Blockly.Msg.grove_gbk_led3 = "state";
Blockly.Msg.grove_gbk_ledurl = "https://wiki.seeedstudio.com/Grove-Red_LED/";
Blockly.Msg.grove_gbk_led_tooltip = "turn LED on Digital Output Pin 4 on or off";

Blockly.Msg.grove_gbk_tone1 = "Play tone on piezo D5";
Blockly.Msg.grove_gbk_tone2 = "Note";
Blockly.Msg.grove_gbk_tone3 = "Scale";
Blockly.Msg.grove_gbk_tone4 = "Time";
Blockly.Msg.grove_gbk_toneurl = "https://www.arduino.cc/reference/en/language/functions/advanced-io/tone/";
Blockly.Msg.grove_gbk_tone_tooltip = "Play a note at the selected frequency and duration";

Blockly.Msg.grove_gbk_oled1 = "write to OLED on I2C";
Blockly.Msg.grove_gbk_oled2 = "Input: String or Number";
Blockly.Msg.grove_gbk_oled3 = "Line (0-3)";
Blockly.Msg.grove_gbk_oled4 = "Column (0-15)";
Blockly.Msg.grove_gbk_oled5 = "refresh line?";
Blockly.Msg.grove_gbk_oledurl = "https://wiki.seeedstudio.com/Grove-OLED-Display-0.96-SSD1315/";
Blockly.Msg.grove_gbk_oled_tooltip = "Print input value at row and column location. Refresh clears the line for overwrite.";

//inputs
Blockly.Msg.grove_gbk_button1 = "read Button on D6";
Blockly.Msg.grove_gbk_buttonurl = "https://wiki.seeedstudio.com/Grove-Button/";
Blockly.Msg.grove_gbk_button_tooltip = "Read digital state of button on D6";

Blockly.Msg.grove_gbk_pot1 = "read Potentiometer on A0";
Blockly.Msg.grove_gbk_roturl = "https://wiki.seeedstudio.com/Grove-Rotary_Angle_Sensor/";
Blockly.Msg.grove_gbk_pot_tooltip = "Read in 0-5V on analog input A0. Value depends on position of knob.";

Blockly.Msg.grove_gbk_ldr1 = "read Light Sensor on A6";
Blockly.Msg.grove_gbk_ldrurl = "https://wiki.seeedstudio.com/Grove-Light_Sensor/";
Blockly.Msg.grove_gbk_ldr_tooltip = "Read Light Sensor on analog input A6. Value depends on intensity of light.";

Blockly.Msg.grove_gbk_snd1 = "read Sound Sensor on A2";
Blockly.Msg.grove_gbk_sndurl = "https://wiki.seeedstudio.com/Grove-Sound_Sensor/";
Blockly.Msg.grove_gbk_snd_tooltip = "Read Sound Sensor on analog input A2. Value depends on intensity of sound.";

Blockly.Msg.grove_gbk_temp1 = "read Temperature or Humidity on D3";
Blockly.Msg.grove_gbk_temp2 = "select reading";
Blockly.Msg.grove_gbk_tempurl = "https://wiki.seeedstudio.com/Grove-TemperatureAndHumidity_Sensor/";
Blockly.Msg.grove_gbk_temp_tooltip = "Read Temperature or Humidity based on input selected.";

Blockly.Msg.grove_gbk_baro1 = "read Air Pressure Sensor on I2C";
Blockly.Msg.grove_gbk_baro2 = "select reading";
Blockly.Msg.grove_gbk_baro3 = "Pressure";
Blockly.Msg.grove_gbk_baro4 = "Altitude";
Blockly.Msg.grove_gbk_barourl = "https://wiki.seeedstudio.com/Grove-Barometer_Sensor-BMP280/";
Blockly.Msg.grove_gbk_baro_tooltip = "Read air pressure from I2C barometric sensor";

Blockly.Msg.grove_gbk_accel1 = "read Accelerometer on I2C";
Blockly.Msg.grove_gbk_accel2 = "select axis";
Blockly.Msg.grove_gbk_accel3 = "X";
Blockly.Msg.grove_gbk_accel4 = "Y";
Blockly.Msg.grove_gbk_accel5 = "Z";
Blockly.Msg.grove_gbk_accelurl = "https://wiki.seeedstudio.com/Grove-3-Axis-Digital-Accelerometer-LIS3DHTR/";
Blockly.Msg.grove_gbk_accel_tooltip = "Read X, Y, Z acceleration from I2C accelerometer";
